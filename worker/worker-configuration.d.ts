/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 78a8e2fb5f7e35dc4dd62e5bb2a0a293)
...
interface __BaseEnv_Env {
	...
	MIN_GAP_MS: "10100";
	DISPATCHER: DurableObjectNamespace<import("./src/index").GemiDispatcher>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GemiDispatcher";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GEMI_BASE" | "REFRESH_AFTER_DAYS" | "MIN_GAP_MS">> {}
}
